...
/// </summary>
public class PdfSignatureStamper
{
    ...
    private PdfSignatureAppearance CreateSignatureAppearance(PdfStamper pdfStamper)
    {
        ...
        signatureAppearance.SignDate = DateTime.Now.ToString(CultureInfo.InvariantCulture);
    ...
    private PdfDictionary CreatePdfDictionary()
    {
        ...
        pdfDictionary.Put(PdfName.CREATIONDATE, new PdfDate(DateTime.Now.ToString(CultureInfo.InvariantCulture)));
