...
public class PdfFontDescriptorV2
{
    ...
    public static PdfFontDescriptorV2 FromFontDescriptor(PdfItem pdfItem, PdfDictionary dict, int objectNumber)
    {
        ...
        PdfItem pdfObjectFontName = dict.FirstOrDefault(prop => prop.Key == FontDescriptor.Keys.FontName).Value;
    ...
    {
        PdfItem baseFontPdfObject = dict.FirstOrDefault(prop => prop.Key == Font.Keys.BaseFont).Value;
        ...
        PdfItem subTypePdfObject = dict.FirstOrDefault(prop => prop.Key == Font.Keys.Subtype).Value;
