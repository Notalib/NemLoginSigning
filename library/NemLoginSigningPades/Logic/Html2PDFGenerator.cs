...
namespace NemLoginSigningPades.Logic
{
    public class Html2PDFGenerator
    {
        public byte[] GeneratePDFDocument(string inputHtml, TransformationPropertiesHandler propertiesHandler)
        {
            ...
            string modifiedHtml = doc.DocumentNode.InnerHtml;
            ...
            Document pdfDocument = new Document(pageSize, pageMarginInPoints, pageMarginInPoints, pageMarginInPoints, pageMarginInPoints);
